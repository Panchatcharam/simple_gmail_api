...
const int VersionInfo::kMajorVersionNumber = 0;//googleapis_VERSION_MAJOR;
const int VersionInfo::kMinorVersionNumber = 2;//googleapis_VERSION_MINOR;
const int VersionInfo::kPatchVersionNumber = 0;//googleapis_VERSION_PATCH;
const char VersionInfo::kVersionDecorator[] = "devel";//googleapis_VERSION_DECORATOR;
